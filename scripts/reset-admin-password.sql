-- beauty-salon-001の管理者パスワードをリセットするSQLスクリプト
-- SupabaseのSQL Editorで実行してください

-- パスワードハッシュを計算（Demo1234）
-- SHA256ハッシュ: Demo1234 -> ハッシュ値
-- 注意: 実際のハッシュ値は実行時に計算する必要があります
...
BEGIN
    ...
    IF v_tenant_id IS NULL THEN
        RAISE EXCEPTION 'テナントコード beauty-salon-001 が見つかりません';
    END IF;
    ...
    RAISE NOTICE '========================================';
    RAISE NOTICE 'テナントコード: beauty-salon-001';
